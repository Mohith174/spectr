      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-lg tracking-widest uppercase">
              Access terminal
            </h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            {error && (
              <p className="text-danger text-xs py-2 border-l-2 border-danger pl-3">
                {error}
              </p>
            )}
          ...
          <div className="text-center space-y-2 text-xs text-muted">
            <div>
              No account?{" "}
              <Link href="/sign-up" className="text-sub hover:text-primary transition-colors">
                Create one →
              </Link>
            </div>
            <div>
              <Link href="/" className="hover:text-sub transition-colors">
                ← Back to home
              </Link>
            </div>
          </div>
